...
class MainManager(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.recs_to_search = QLabel('Records to find: ')
        self.recs_found = QLabel('Records found: ')
    ...
    def run_search(self):
        # The actual report is generated by the search_logic.py module
        # What is returned is just an int representing number of tota rows
        # returned. Number of record found is number of rows returned minues 1
        # for the header rows with column names.
        number_of_found = sl.finder_main(self.search_numbers, self.report) - 1
        ...
        self.recs_to_search.update()
        self.recs_found.update()
